    ...
    <>
      <main className="flex flex-col h-screen">
          <div className="flex flex-1 flex-col">
            <div className="flex flex-1 flex-col overflow-y-scroll px-4 bg-gray-100">
              <div className="flex items-start justify-center space-x-2 p-4 overflow-scroll">
                <div className="col-span-1 bg-white h-fit w-1/3 p-2 flex flex-col">
                  <h5 className="text-center text-3xl pb-3">
                    Checkout!!
                  </h5>
                  <img
                  ...
                  <h3 className="text-center text-2xl font-semibold">
                    ...
                    {singleProduct?.car_model_id
                      ? singleProduct.car_model_id[1]
                      : ""}
                  </h3>
                  ...
                  <h3 className=" text-gray-700 text-base font-normal capitalize py-3 border-b border-gray-300">
                    Vendor :{" "}
                    {singleProduct?.vendor_id
                      ? singleProduct?.vendor_id[1]
                      : "No vendor registered"}
                  </h3>
                  <h3 className=" text-gray-700 text-base font-normal capitalize py-3 border-b border-gray-300">
                    Transmission :{" "}
                    {singleProduct?.transmission
                      ? singleProduct?.transmission
                      : "No transmission registered"}
                  </h3>
                  <h3 className=" text-gray-700 text-base font-normal capitalize py-3 border-b border-gray-300">
                    Mileage :{" "}
                    {singleProduct?.mileage
                      ? singleProduct?.mileage
                      : "No mileage registered"}{" "}
                    miles
                  </h3>
                  <h3 className=" text-gray-700 text-base font-normal capitalize py-3 border-b border-gray-300">
                    Price : UGX{" "}
                    {singleProduct?.selling_price
                      ? numberWithCommas(singleProduct?.selling_price)
                      : "No price registered"}
                  </h3>
